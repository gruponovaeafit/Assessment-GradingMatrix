...
interface EditParticipantModalProps {
  ...
  setEditModal: (val: ParticipantDashboardRow | null) => void;
  onCancel: () => void;
...
export const EditParticipantModal: React.FC<EditParticipantModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 animate-fadeIn" role="dialog" aria-modal="true" aria-labelledby="edit-modal-title">
      <div className="bg-[#1e1e1e] rounded-lg p-4 sm:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto border border-gray-700 shadow-2xl">
        <h2 id="edit-modal-title" className="text-lg sm:text-xl font-bold mb-4 text-white">Editar Participante</h2>
        ...
        <form onSubmit={onUpdate}>
          ...
          <select
            ...
            className="w-full border border-gray-600 px-3 py-2 rounded mb-4 text-white bg-[#2d2d2d] text-sm sm:text-base focus:border-[color:var(--color-accent)] focus:outline-none"
          >
