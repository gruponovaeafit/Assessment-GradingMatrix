...
export default function DashboardTabla() {
  ...
  const { confirm, setIsLoading: setModalLoading, ConfirmModalComponent } =
    useConfirmModal();
  ...
  return (
    <div className="flex flex-col items-center min-h-screen py-4 sm:py-8 px-2 sm:px-4 bg-white">
      {/* Header */}
      ...
      {/* Paginación (afuera del table wrapper) */}
      {totalPages > 1 && (
